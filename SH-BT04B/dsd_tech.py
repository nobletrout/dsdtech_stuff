...
# True = on, False = off
enum_ports = {
    0:{True: [0xA1,0x04,0xD2,0x01,0x01], False:[0xA1,0x04,0xD2,0x02,0x01]},
    1:{True: [0xA1,0x04,0xD2,0x01,0x02], False:[0xA1,0x04,0xD2,0x02,0x02]},
    2:{True: [0xA1,0x04,0xD2,0x01,0x03], False:[0xA1,0x04,0xD2,0x02,0x03]},
    3:{True: [0xA1,0x04,0xD2,0x01,0x04], False:[0xA1,0x04,0xD2,0x02,0x04]}
}
...
def message_prep(myArray):
    ...
    for i in myArray:
        xor_byte = xor_byte ^ i
    returnArray = myArray + [xor_byte, 0xAA]
